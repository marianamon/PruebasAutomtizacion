...
public class TestCrearPagoParcial extends ClassBase {
	...
	public void cotizaroferta() throws Exception {
		...
		CrearPagoParcial TestCrearpagoparcial = new CrearPagoParcial(driver);
		...
		AssertJUnit.assertEquals(Actualtext,"ID Pago Parcial Agrupado # 23");
