...
public class TestCotizaOfertaZonaNOElite_estrato456PaqueteTrio extends ClassBase {
...
@Test(dataProvider = "TestDatatrio_zonaNOelite_Est456")	//@Parameters({ "username", "password" })
...
//datos dinamicos en el archivo testdata que llama la anotacion Dataprovider de testNG
	  @DataProvider(name = "TestDatatrio_zonaNOelite_Est456")
		public Object[][] pasarDatos() {
		  
		 
		  TestData Excel = new TestData("C:\\Users\\lalzates\\workspace\\proyectos\\SuiteCotizador\\TestDatatrio_zonaNOelite_Est456.xls");
