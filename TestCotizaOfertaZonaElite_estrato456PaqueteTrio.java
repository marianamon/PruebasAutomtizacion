...
* en zona Elite en paquete TRIO y mediante la anotación 
* DataDriven crear juego de pruebas por Departamento,Cuidad, Estrato 4-5-6,Oferta y producto.
 */ 
...
public class TestCotizaOfertaZonaElite_estrato456PaqueteTrio extends ClassBase {
	private static StringBuffer verificationErrors = new StringBuffer();

	@Test(dataProvider = "TestDatatrio_zonaElite_Est456")	//@Parameters({ "username", "password" })

	public void cotizaroferta( String Departamento, String Cuidad, String Estrato, String Oferta,String Direccion, String TO, String TV, String BA) throws Exception {
	...
	//datos dinamicos en el archivo testdata que llama la anotacion Dataprovider de testNG
		  @DataProvider(name = "TestDatatrio_zonaElite_Est456")
			public Object[][] pasarDatos() {
			  
			 
			  TestData Excel = new TestData("C:\\Users\\lalzates\\workspace\\proyectos\\SuiteCotizador\\TestDatatrio_zonaElite_Est456.xls");
			  Log . info ( "Ingreso al archivo de excel" ) ; 
			  
			  int fila = Excel.obtenerCantFilas();
			  
				Object[][] datos = new Object[fila-1][8];
