...
public class TestCotizaOfertaZonaElite_estrato123PaqueteTrio  extends ClassBase {
	
	private static StringBuffer verificationErrors = new StringBuffer();

	@Test(dataProvider = "TestDatatrio_zonaElite_Est123")	//@Parameters({ "username", "password" })
	...
	//datos dinamicos en el archivo testdata que llama la anotacion Dataprovider de testNG
		  @DataProvider(name = "TestDatatrio_zonaElite_Est123")
			public Object[][] pasarDatos() {
			  
			 
			  TestData Excel = new TestData("C:\\Users\\lalzates\\workspace\\proyectos\\SuiteCotizador\\TestDatatrio_zonaElite_Est123.xls");
